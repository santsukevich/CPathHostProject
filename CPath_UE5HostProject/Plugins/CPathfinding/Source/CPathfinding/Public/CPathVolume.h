...
protected:
	...
	{
		if (LocalCoordsInt3.X < 0 || LocalCoordsInt3.X >= NodeCount[0])
			return false;

		if (LocalCoordsInt3.Y < 0 || LocalCoordsInt3.Y >= NodeCount[1])
			return false;

		if (LocalCoordsInt3.Z < 0 || LocalCoordsInt3.Z >= NodeCount[2])
			return false;
